...
public:
	...
	//Haz otro constructor para el agua; mira agua y scene de POO
	Terreno(HWND hWnd, OpenGLClass* OpenGL, const wchar_t* alturas, const wchar_t* textura, const wchar_t* normal1, const wchar_t* textura2, const wchar_t* normal2,
		const wchar_t* textura3, const wchar_t* normal3, const wchar_t* Blend, float ancho, float prof, int numtext, int numtext2, int numtext3, int numtext4, int numtext5, int numtext6, int numtext7)
	{
		anchof = ancho;
		proff = prof;
		...
		CargarTextura(textura, numtext, OpenGL);
		CargarTextura(normal1, numtext2, OpenGL);
		CargarTextura(textura2, numtext3, OpenGL);
		CargarTextura(normal2, numtext4, OpenGL);
		CargarTextura(textura3, numtext5, OpenGL);
		CargarTextura(normal3, numtext6, OpenGL);
		CargarTextura(Blend, numtext7, OpenGL);
	}
	...
	void CargarTextura(const wchar_t* textura, int numtext, OpenGLClass* OpenGL) {
		Carga(textura);
