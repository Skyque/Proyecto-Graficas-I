...
public:	
	...
	Billboard(HWND hWnd, OpenGLClass* OpenGL, const wchar_t textura[], const wchar_t normal[], float escalaX, float escalaY, float x, float z, int numtext, int numtext2)
	{
		...
		CargarTextura(normal, numtext2, OpenGL);

		billbo = BillBoardBasico(this->escalaX, this->escalaY);
