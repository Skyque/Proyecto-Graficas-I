...
public:
	...
	Maya BillBoardBasico(float escalaX, float escalaY)
	{
		...
		verticesxyzSD[0].Posx = -0.5 * escalaX;
		verticesxyzSD[0].Posy = 0 * escalaY;
		verticesxyzSD[0].Posz = 0 * escalaX;
		...
		verticesxyzSD[1].Posx = -0.5 * escalaX;
		verticesxyzSD[1].Posy = 1 * escalaY;
		verticesxyzSD[1].Posz = 0 * escalaX;
		...
		verticesxyzSD[2].Posx = 0.5 * escalaX;
		verticesxyzSD[2].Posy = 1 * escalaY;
		verticesxyzSD[2].Posz = 0 * escalaX;
		...
		verticesxyzSD[3].Posx = 0.5 * escalaX;
		verticesxyzSD[3].Posy = 0 * escalaY;
		verticesxyzSD[3].Posz = 0 * escalaX;
